...
void SimpleEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    //audio blocks presenting each channel
    auto leftBlock = block.getSingleChannelBlock(0);
    auto rightBlock = block.getSingleChannelBlock(1);

    //creating processing context that wraps each individual audio block for the channels
...
{
    //defining LowCut, HighCut and Peak Bands
    ...
    //defining choices per Octave (multiples of 12)
